...
ABBREVIATION_MAP = {
    ...
    "RELIANCE":   ["RIL", "Reliance Jio", "Jio", "Mukesh Ambani company", "Reliance Industries"],
    "TCS":        ["Tata Consultancy", "Tata Consulting", "TCS Ltd"],
    "INFY":       ["Infy", "Infosys Technologies", "Infosys Ltd"],
    "HDFCBANK":   ["HDFC Bank", "HDFC"],
    "ICICIBANK":  ["ICICI Bank", "ICICI"],
    "BHARTIARTL": ["Airtel", "Bharti Airtel", "Bharti"],
    "SBIN":       ["SBI", "State Bank", "State Bank of India"],
    "WIPRO":      ["Wipro Technologies", "Wipro Ltd"],
    "ITC":        ["ITC Ltd", "Indian Tobacco"],
    "KOTAKBANK":  ["Kotak Bank", "Kotak Mahindra", "Kotak Mahindra Bank"],
    # Additional NSE watchlist abbreviations
    ...
    "DIVISLAB":   ["Divi's Lab", "Divis Laboratories", "Divi's Laboratories"],
    "DMART":      ["DMart", "D-Mart", "Avenue Supermarts"],
    "ETERNAL":    ["Zomato", "Eternal Ltd"],
    "FEDERALBNK": ["Federal Bank"],
    "FORTIS":     ["Fortis Healthcare", "Fortis Hospital"],
    "GLAND":      ["Gland Pharma"],
    ...
    "ICICIGI":    ["ICICI Lombard", "ICICI General Insurance"],
    "ICICIPRULI": ["ICICI Prudential", "ICICI Pru Life"],
    "IDFCFIRSTB": ["IDFC First Bank", "IDFC First"],
    "IEX":        ["Indian Energy Exchange", "IEX India"],
    "INDHOTEL":   ["Indian Hotels", "Taj Hotels", "IHCL"],
    "JIOFIN":     ["Jio Financial", "Jio Financial Services"],
    "KALYANKJIL": ["Kalyan Jewellers", "Kalyan"],
    "LALPATHLAB": ["Lal PathLabs", "Dr Lal PathLabs", "Lal Path Labs"],
    "LTTS":       ["L&T Tech", "L&T Technology Services"],
    "MAXHEALTH":  ["Max Healthcare", "Max Hospital"],
    "MEDANTA":    ["Medanta", "Global Health"],
    "NESTLEIND":  ["Nestle India", "Nestle"],
    "NH":         ["Narayana Health", "Narayana Hrudayalaya"],
    "NMDC":       ["NMDC Ltd", "NMDC Steel"],
    "NTPC":       ["NTPC Ltd", "National Thermal Power"],
    "NYKAA":      ["Nykaa", "FSN E-Commerce"],
    "POWERGRID":  ["Power Grid", "PGCIL", "Power Grid Corporation"],
    "SBICARD":    ["SBI Card", "SBI Cards"],
    "SBILIFE":    ["SBI Life", "SBI Life Insurance"],
    "SWIGGY":     ["Swiggy Ltd"],
    "TAJGVK":     ["Taj GVK", "GVK Hotels"],
    ...
    "TRENT":      ["Trent Ltd", "Tata Trent", "Westside"],
    "UJJIVANSFB": ["Ujjivan", "Ujjivan Small Finance"],
    "UNITDSPR":   ["United Spirits", "Diageo India"],
    "VGUARD":     ["V-Guard", "VGuard"],
    "VOLTAS":     ["Voltas Ltd", "Voltas Air Conditioner"],
