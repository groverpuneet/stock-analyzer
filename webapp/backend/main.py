...
from routers import signals, stocks, macro, watchlist, opportunities, chat, refresh, dashboard, quality  # noqa: E402
...
for r in (signals.router, stocks.router, macro.router, watchlist.router,
          opportunities.router, chat.router, refresh.router, dashboard.router, quality.router):
